//-----------------------  ------------------------
// В программировании есть общий термин: «замыкание», – которое 
...
//     или функция должна быть написана специальным образом, чтобы 
//     получилось замыкание. Но, как было описано выше, в JavaScript,
//     все функции изначально являются замыканиями.
// То есть они автоматически запоминают, где были созданы, с помощью
//     скрытого свойства [[Environment]], и все они могут получить 
...
//     являются замыканиями, и, может быть, несколько слов 
//     о технических деталях: свойстве [[Environment]] и о том, 
